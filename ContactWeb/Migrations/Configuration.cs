namespace ContactWeb.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ContactWeb.Models.ContactWebContext>
    {
        ...
        {
            //85210aa3 - a12f - 4499 - 91d3 - 39ffb03c3d93//
            //f8cb7775 - d842 - 4a5f - b016 - 9a02fcec51db//
            context.Contacts.AddOrUpdate(
                  ...
                  new Models.Contact
                  {
                      ...
                      StreetAddress2 = "Starship Enterprise NCC-1701"
                                      ,
                      UserId = new Guid("85210aa3-a12f-4499-91d3-39ffb03c3d93")
                                      ,
                      Zip = "98765"
                  }
                  , new Models.Contact
                  {
                      ...
                      StreetAddress2 = "Starship Enterprise NCC-1701"
                                      ,
                      UserId = new Guid("f8cb7775-d842-4a5f-b016-9a02fcec51db")
                                      ,
                      Zip = "87654"
                  }
                  , new Models.Contact
